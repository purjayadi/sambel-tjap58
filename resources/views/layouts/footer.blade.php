        ...
        <div class="w-80 lg:flex-1 md:mx-0 mx-auto text-center md:text-left">
            <div class="w-80 md:flex items-center justify-center md:mx-0 mx-auto text-center md:text-left">
                ...
                <div class="flex-shrink-0 pt-2">
                    <div class="font-bold">PT. Cahaya Brajamarketindo</div>
                    <p>
                        <small>Wisma GKBI Lantai 39, Jl. Jendral Sudirman No. 28
                            <br />Kel. Bendungan Hilir, Kec. Tanah Abang, Kota Adm. Jakarta Pusat</small>
                    </p>
                </div>
            </div>
        </div>
        <div class="flex-1 md:pl-20 -mb-10 pt-10 md:mt-0 mt-2 md:text-center">
            <div class="lg:w-auto md:w-1/2 w-full px-4">
                <a href="" class="text-blue-500">
                    <i class="fab fa-facebook-f "></i>
                </a>
                <a href="" class="ml-3 text-blue-400">
                    <i class="fab fa-twitter"></i>
                </a>
                <a href="" class="ml-3 text-red-500">
                    <i class="fab fa-youtube"></i>
                </a>
                <a href="" class="ml-3 text-pink-600">
